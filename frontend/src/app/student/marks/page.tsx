...
const fakeGrades = [
  ...
  { id: 3, firstName: "Mansour", lastName: "Ali", ds: 12.5, tp: 10, exam: 15 },
  { id: 4, firstName: "Gharbi", lastName: "Nour", ds: 7.3, tp: 10, exam: 15 },
  { id: 5, firstName: "Khaled", lastName: "Rania", ds: 10.0, tp: 10, exam: 15 },
];
